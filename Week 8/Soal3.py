...
if __name__ == "__main__":
    ...
    print("Menggunakan lambang maxterm: ")
    str_lambang = KALI.join(list_lambang)
    print("f(k,s,t) = "+str_lambang)

    str_pi = ','.join(list_index)
    print("Menggunakan lambang maxterm dan pi:")
    print("f(k,s,t) = "+PI+'('+str_pi+')')